class TiledPlatform extends Phaser.Scene {
    ...
    create() {
        ...
        // Add arcade physics to powerups
        this.physics.world.enable(this.bluePowerUps, Phaser.Physics.Arcade.STATIC_BODY);
        this.bluePowerUpGroup = this.add.group(this.bluePowerUps); // Add powerups to collision group
        ...
        // Add particles and create overlap for coins
        this.coinCollectVfxManager = this.add.particles('kenney_sheet', 987);

        this.coinCollectVfxEffect = this.coinCollectVfxManager.createEmitter({
            follow: this.p1,
            quantity: 20,
        ...
        this.physics.add.overlap(this.p1, this.coinGroup, (obj1, obj2) => {
            ...
            this.coinCollectVfxEffect.explode();
        });

        // Add particles and create overlap for powerup
